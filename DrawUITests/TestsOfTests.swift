...
class TestsOfTests: XCTestCase {
    ...
    func testSingleStrokeWithUpdate() throws {
        ...
        pointStream.addConsumer { (input) -> Void in
            output = input
        }
        pointStream.process(Array(events[0...1]))
